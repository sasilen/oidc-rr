 ...
 * Users Model
 *
 * @property \App\Model\Table\ResourceserversTable&\Cake\ORM\Association\BelongsToMany $Resourceservers
...
class UsersTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->belongsToMany('Resourceservers', [
            'foreignKey' => 'user_id',
            'targetForeignKey' => 'resourceserver_id',
            'joinTable' => 'resourceservers_users',
        ]);
